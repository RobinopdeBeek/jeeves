...
function QuoteBlockIcon({
  className,
  ...props
}: ComponentProps<typeof IconQuote>) {
  return (
    <IconQuote
...
function QuoteBlockText({ className, ...props }: ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "min-w-0 text-sm text-muted-foreground/80 italic line-clamp-2",
        className,
      )}
      {...props}
    />
 ...
 *
 * Pass this to `MessagePrimitive.Parts` as the `Quote` renderer, or render via
 ...
 * Render inside `ThreadPrimitive.Root`.
 */
...
function ComposerQuotePreviewRoot({
  ...
  return (
    <ComposerPrimitive.Quote
      ...
      className={cn(
        "mx-1 mt-0.5 flex items-start gap-2 rounded-lg bg-muted/60 px-2.5 py-2",
        className,
      )}
      {...props}
    />
...
function ComposerQuotePreviewText({
  ...
  return (
    <ComposerPrimitive.QuoteText
      ...
      className={cn(
        "min-w-0 flex-1 text-sm text-muted-foreground line-clamp-2",
        className,
      )}
      {...props}
    />
