...
> **Superseded by [ADR 0014](./0014-tasks-drafts-are-versioned-artifacts.md)** for Tasks shaping: tip drafts are versioned `tasks-draft` artifacts; real child cards appear only at fan-out.
