...
- `/to-tasks` and similar structured-output skills document their sidecar path and Zod schema alongside the prompt; parse failures surface as run errors with retry, not silent bad data.
