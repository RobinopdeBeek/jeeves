...
(`prepeval`) when a card is in the Review column — after Plan → Implement → AI Review have
...
assemble the Evaluation ([ADR 0015](../adr/0015-ai-review-reworks-eval-on-human-review-entry.md)).
